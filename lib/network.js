    ...
    try {
      if ({}.hasOwnProperty.call(sections, i)) {
        ...
        if (sections[i].trim() !== '') {
          ...
          try {
            const _linesNicConfig = nconfigsections[i].trim().split('\r\n');
            linesNicConfig = _linesNicConfig;
          } 
          catch (e) {
          ...
          if (netEnabled !== '') {
            ...
            nics.push({
              ...
              dhcp: linesNicConfig ? (util.getValue(linesNicConfig, 'dhcpEnabled', ':').toLowerCase() === 'true') : false,
              name: ifacename,
              iface,
